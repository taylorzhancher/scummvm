...
#ifndef GRIFFON_TALK_H
#define GRIFFON_TALK_H
...
////////There is no object.h and saveload.h fo griffon
//#include "griffon/objects.h"
//#include "griffon/saveload.h"
...
protected:
	...
	OpcodeReturn cmdGriffonOff(const byte *&str);
	OpcodeReturn cmdGriffonOn(const byte *&str);
